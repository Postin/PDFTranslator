...
def build_cli_parser():
    ...
    parser.add_argument("--lang", type=str, default="both", choices=["english", "serbian", "both"], help="Translation output")
    ...
    parser.add_argument("--output-dir", type=str, default="translated_pages", help="Output directory for translation files")
